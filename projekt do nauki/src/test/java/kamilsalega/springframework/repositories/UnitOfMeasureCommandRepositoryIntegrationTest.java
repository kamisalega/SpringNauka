...
@DataJpaTest
public class UnitOfMeasureCommandRepositoryIntegrationTest {
    ...
    public void findByDescription() throws Exception{
        ...
        Optional<UnitOfMeasure> unitOfMeasureOptional = unitOfMeasureRepository.findByDescription("Lyzeczka");
        assertEquals("Lyzeczka", unitOfMeasureOptional.get().getDescription());
    }
